...
public class SecureSystem {
	...
	public static void main(String[] args){
		...
		if(args.length != 1){
			System.err.println("Invalid number of arguments. You may only pass one argument after 'java SecureSystem' - the name of the instructionList file.\nYou passed: " + args.length + " arguments.");
			return;
		}
	...
	private static void executeFileCommands(String path) {
		...
		try{
			...
			System.err.println("The file " + path + " could not be found. Execution cancelled.");	
		}
	}
